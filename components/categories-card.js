    ...
    <section className="w-full h-screen bg-white flex items-center justify-center">
      <div className="w-4/5 lg:h-4/5 md:h-4/5 sm:h-full vs:h-full bg-gray-300 rounded-3xl flex flex-col justify-center items-center">
        ...
        <div className="w-4/5 lg:h-3/5 md:h-3/5 sm:h-4/5 vs:h-4/5 grid grid-cols-5 gap-4 items-center justify-center">
          <div className="bg-white w-full h-full relative overflow-hidden rounded-3xl lg:col-span-2 md:col-span-2 sm:col-span-5  vs:col-span-5 flex items-center justify-center ">
            {" "}
            <Image
              src={data[0].image}
              width={150}
          ...
          <div className="bg-white w-full h-full relative overflow-hidden rounded-3xl lg:col-span-3 md:col-span-3 sm:col-span-5 vs:col-span-5 flex items-center justify-center">
            <Image
              src={data[1].image}
              width={150}
              height={150}
